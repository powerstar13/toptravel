...
/**
 * @fileName    : ServiceareaCronController.java
 * @author      : 홍준성
 * @description : 휴게소 API 및 DB 처리 관련 cron 컨트롤러 모음
 * @lastUpdate  : 2019. 5. 09.
 */
/** 컨트롤러 선언 */
@Controller
public class ServiceareaCronController {
    /** cron 설정 시간 */
    // 휴게소 API 정보 추가를 위한 액션 컨트롤러 (cron="0 0 01 2 * ?")                 매월 2일  01시
    // 휴게소 전기차 충전소API 정보 추가를 위한 액션 컨트롤러 (cron="0 10 01 2 * ?")   매월 2일  01시 10분
    // 휴게소 전체 푸드메뉴 API 정보 추가를 위한 액션 컨트롤러 (cron="0 30 01 20 * ?") 매월 20일 01시 30분
    // 휴게소 대표음식 API 정보 추가를 위한 액션 컨트롤러 (cron="0 40 01 20 * ?")      매월 20일 01시 40분
    // 휴게소 유가정보 API 정보 추가를 위한 액션 컨트롤러 (cron="0 0 02 * * ?")        매일      02시
    // 휴게소 편의시설 API 정보 추가를 위한 액션 컨트롤러 (cron="0 40 01 2 * ?")       매월 2일  01시 40분
    // 휴게소 테마 API 정보 추가를 위한 액션 컨트롤러 (cron="0 45 01 2 * ?")           매월 2일  01시 45분
    // 휴게소 위치 API 정보 추가를 위한 액션 컨트롤러 (cron="0 50 01 2 * ?")           매월 2일  01시 50분
    // 휴게소 이미지 API 정보 추가를 위한 액션 컨트롤러 (cron="0 0 02 20 * ?")         매월 20일 02시
    // 휴게소 완성 정보 추가를 위한 액션 컨트롤러 (cron="0 30 02 * * ?")               매일      02시 30분
    
    /** (1) 사용하고자 하는 Helper + Service 객체 선언 */
    // -> import org.slf4j.Logger;
    // -> import org.slf4j.LoggerFactory;
    Logger logger = LoggerFactory.getLogger(ServiceareaCronController.class); // Log4j 객체 직접 생성
    // -> import org.apache.ibatis.session.SqlSession;
    @Autowired
     ...
     */
    @Scheduled(cron="0 0 01 2 * ?")
    public void serviceareaApiInsertCron() {
        /** (2) 휴게소 API를 연동하기 + Service를 통한 휴게소 정보 저장 */
        String pageSize = "1";
    ...
    } // End serviceareaApiInsertCron Method
    
    /**
     * 휴게소 전기차 충전소API 정보 추가를 위한 액션 컨트롤러
     */
    @Scheduled(cron="0 10 01 2 * ?")
    public void serviceareaCsApiInsertCron() {
    ...
    } // End serviceareaCsApiInsertCron Method
    
    /**
     * 휴게소 전체 푸드메뉴 API 정보 추가를 위한 액션 컨트롤러
     */
    @Scheduled(cron="0 30 01 20 * ?")
    public void serviceareaFoodAllApiInsertCron() {
        /** (4) 휴게소 API를 연동하기 + Service를 통한 휴게소 정보 저장 */
        String pageSize = "1";
    ...
    } // End serviceareaFoodAllApiInsertCron Method
    
    /**
     * 휴게소 대표음식 API 정보 추가를 위한 액션 컨트롤러
     */
    @Scheduled(cron="0 40 01 20 * ?")
    public void serviceareaFoodApiInsertCron() {
        /** (4) 휴게소 API를 연동하기 + Service를 통한 휴게소 정보 저장 */
        String pageSize = "1";
    ...
    } // End serviceareaFoodApiInsertCron Method
    
    /**
     * 휴게소 유가정보 API 정보 추가를 위한 액션 컨트롤러
     */
    @Scheduled(cron="0 0 02 * * ?")
    public void serviceareaOilApiInsertCron() {
        /** (4) 휴게소 API를 연동하기 + Service를 통한 휴게소 정보 저장 */
        String pageSize = "1";
    ...
    } // End serviceareaOilApiInsertCron Method
    
    /**
     * 휴게소 편의시설 API 정보 추가를 위한 액션 컨트롤러
     */
    @Scheduled(cron="0 40 01 2 * ?")
    public void serviceareaPsApiInsertCron() {
        /** (4) 휴게소 API를 연동하기 + Service를 통한 휴게소 정보 저장 */
        String pageSize = "1";
    ...
    } // End serviceareaPsApiInsertCron Method
    
    /**
     * 휴게소 테마 API 정보 추가를 위한 액션 컨트롤러
     */
    @Scheduled(cron="0 45 01 2 * ?")
    public void serviceareaThemeApiInsertCron() {
        /** (4) 휴게소 API를 연동하기 + Service를 통한 휴게소 정보 저장 */
        String pageSize = "1";
    ...
    } // End serviceareaThemeApiInsertCron Method
    
    /**
     * 휴게소 위치 API 정보 추가를 위한 액션 컨트롤러
     */
    @Scheduled(cron="0 50 01 2 * ?")
    public void serviceareaPlaceApiInsertCron() {
        /** (4) 휴게소 API를 연동하기 + Service를 통한 휴게소 정보 저장 */
        List<Servicearea> list = null;
        try {
            list = serviceareaService.selectServiceareaList(null);
    ...
    } // End serviceareaPlaceApiInsertCron Method
    
    /**
     * 휴게소 이미지 API 정보 추가를 위한 액션 컨트롤러
     */
    @Scheduled(cron="0 0 02 20 * ?")
    public void serviceareaImageApiInsertCron() {
        /** (4) 휴게소 API를 연동하기 + Service를 통한 휴게소 정보 저장 */
    ...
    } // End serviceareaImageApiInsertCron Method
    
    /**
     * 휴게소 완성 정보 추가를 위한 액션 컨트롤러
     */
    @Scheduled(cron = "0 30 02 * * ?")
    public void serviceareaGroupInsertCron() {
        /** (4) 휴게소 API를 연동하기 + Service를 통한 휴게소 정보 저장 */
        List<Servicearea> list = null;
        try {
            list = serviceareaService.selectServiceareaList(null);
    ...
    } // End serviceareaGroupInsertCron Method
