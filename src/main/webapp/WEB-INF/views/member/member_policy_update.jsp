...
<article class="page-header">
    <h3 class="color3">정책안내 수정</h3>
</article>
<!-- //page header -->

<div class="container-fluid member_join_agreement">
    <!-- 수정을 위한 폼 시작 -->
    <form action="${pageContext.request.contextPath}/member/member_policy_update_ok.do" method="POST" class="form-horizontal" role="form" id="policy_update_form">
        <legend class="blind">정책안내 수정</legend>
        ...
        <div class="form-group">
            ...
            <div class="col-md-10">
                <textarea name="agreementDoc" id="agreementDoc" class="form-control serviceText" rows="30">${item.agreementDoc}</textarea>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-10">
                <textarea name="infoCollectionDoc" id="infoCollectionDoc" class="form-control serviceText" rows="30">${item.infoCollectionDoc}</textarea>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-10">
                <textarea name="communityDoc" id="communityDoc" class="form-control serviceText" rows="30">${item.communityDoc}</textarea>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-10">
                <textarea name="emailCollectionDoc" id="emailCollectionDoc" class="form-control serviceText" rows="30">${item.emailCollectionDoc}</textarea>
            </div>
        </div>
...
<%@ include file="/WEB-INF/inc/CommonScript.jsp" %>
    ...
    <script src="${pageContext.request.contextPath}/assets/js/member_policy_update.js"></script>
