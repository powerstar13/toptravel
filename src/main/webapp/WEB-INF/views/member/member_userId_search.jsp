...
<!DOCTYPE html>
<!--
    @fileName    : member_userId_search.jsp
    @author      : 홍준성
    @description : 아이디 찾기 View
...
<div class="container-fluid member_userId_search">
    <!-- Nav tabs -->
    ...
    <article class="col-md-6 col-md-offset-3 margin_top10">
        <!-- 아이디 찾기 폼 -->
        <form action="${pageContext.request.contextPath}/member/member_userId_search_ok.do" method="POST" class="form-horizontal margin_top50" id="member_join_or_userId_userPw_search" role="form">
