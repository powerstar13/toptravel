...
<div class="row clearfix">
    ...
    <article class="col-md-10 pull-left">
        ...
        <!-- 노선 검색 폼 -->
        <form action="${pageContext.request.contextPath}/servicearea/servicearea_line.do" method="GET" id="line_search" class="form-horizontal" role="form">
            <fieldset>
...
<c:choose>
    ...
    <c:otherwise>
                ...
                <li>
                    <a href="#">
                        <span class="name">조회된 노선 목록이 없습니다.</span>
                    </a>
                </li>
    </c:otherwise>
</c:choose>
...
<c:choose>
    <c:when test="${pageHelper.prevPage > 0}">
        ...
        <c:url var="prevUrl" value="/servicearea/servicearea_line.do">
...
<c:forEach var="i" begin="${pageHelper.startPage}" end="${pageHelper.endPage}" varStatus="status">
    ...
    <c:url var="pageUrl" value="/servicearea/servicearea_line.do">
        <c:param name="lineName" value="${lineName}" />
...
<c:choose>
    <c:when test="${pageHelper.nextPage > 0}">
        ...
        <c:url var="nextUrl" value="/servicearea/servicearea_line.do">
            <c:param name="lineName" value="${lineName}" />
