...
<div class="row clearfix">
    ...
    <article class="col-md-10 pull-left">
        ...
        <!-- 노선별 휴게소 유가정보 테이블 -->
        <div class="line_title clearfix margin_top40">
            <h4 class="pull-left">
                <span class="icon">
...
<c:choose>
    <c:when test="${pageHelper.prevPage > 0}">
        ...
        <c:url var="prevUrl" value="/servicearea/servicearea_oil_result.do">
...
<c:forEach var="i" begin="${pageHelper.startPage}" end="${pageHelper.endPage}" varStatus="status">
    ...
    <c:url var="pageUrl" value="/servicearea/servicearea_oil_result.do">
        <c:param name="routeName" value="${routeName}" />
...
<c:choose>
    <c:when test="${pageHelper.nextPage > 0}">
        ...
        <c:url var="nextUrl" value="/servicearea/servicearea_oil_result.do">
            <c:param name="routeName" value="${routeName}" />
