...
<c:choose>
    <c:when test="${pageHelper.prevPage > 0}">
        ...
        <c:url var="prevUrl" value="/servicearea/servicearea_radar.do">
            <c:param name="placeId" value="${placeId}" />
...
<c:forEach var="i" begin="${pageHelper.startPage}" end="${pageHelper.endPage}" varStatus="status">
    ...
    <c:url var="pageUrl" value="/servicearea/servicearea_radar.do">
        <c:param name="placeId" value="${placeId}" />
...
<c:choose>
    <c:when test="${pageHelper.nextPage > 0}">
        ...
        <c:url var="nextUrl" value="/servicearea/servicearea_radar.do">
            <c:param name="placeId" value="${placeId}" />
...
<c:if test="${fn: length(groupList) > 0}">
    ...
    <script src="${pageContext.request.contextPath}/assets/js/servicearea_radar.js"></script>
</body>
</html>
