            ...
            <thead>
                <tr>
                    ...
                    <th class="text-center">
                        <img src="${pageContext.request.contextPath}/images/servicearea/theme.png" class="img-rounded" width="25" /> 테마명칭
                    </th>
                    <th class="text-center">
...
<c:choose>
    <c:when test="${fn: length(groupList) > 0}">
        ...
        <c:forEach var="item" items="${groupList}">
            ...
            <c:choose>
                <c:when test="${item.themeItemName != null}">
                    <td>${item.themeItemName}</td>
                </c:when>
                <c:otherwise>
...
<c:choose>
    <c:when test="${pageHelper.prevPage > 0}">
        ...
        <c:url var="prevUrl" value="/servicearea/servicearea_theme_result.do">
...
<c:forEach var="i" begin="${pageHelper.startPage}" end="${pageHelper.endPage}" varStatus="status">
    ...
    <c:url var="pageUrl" value="/servicearea/servicearea_theme_result.do">
        <c:param name="routeName" value="${routeName}" />
...
<c:choose>
    <c:when test="${pageHelper.nextPage > 0}">
        ...
        <c:url var="nextUrl" value="/servicearea/servicearea_theme_result.do">
            <c:param name="routeName" value="${routeName}" />
