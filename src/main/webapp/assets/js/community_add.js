$(function() {
	...
	// add-form을 ajaxForm plugin으로 submit
    $("#add-form").form_helper({
    	rules: {
            "title": {
                "required": true,
                "minlength": 2
        ...
        beforeSubmit: function(arr, form, options) {
        	...
        	// add-form validate plugin 다시 실행
            return $("#add-form").valid();
        },
        success: function(json) {
        	if (json.rt == "OK") {
	        	alert("<font color='#05a'>Success</font>", "<strong>새 글이 등록되었습니다.</strong>", function() {
        		...
        		alert("<font color='#05a'>Error</font>", "<strong>글 등록에 실패했습니다. <br />관리자에게 문의하세요.</strong>", function() {
