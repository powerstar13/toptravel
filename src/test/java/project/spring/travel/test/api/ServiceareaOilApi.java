...
public class ServiceareaOilApi {
    @Autowired
...
//        String now_page = "1";
//        String url = "http://data.ex.co.kr/openapi/business/curStateStation?key=2017172116&type=json&numOfRows=10000&pageNo=" + now_page;
...
//            while(bool) {
//                url = "http://data.ex.co.kr/openapi/business/curStateStation?key=2017172116&type=json&numOfRows=10000&pageNo=" + now_page;
...
//            url = "http://data.ex.co.kr/openapi/business/curStateStation?key=2017172116&type=json&numOfRows=10000&pageNo=" + i;
//            is = httpHelper.getWebData(url, "utf-8");
//            json = jsonHelper.getJSONObject(is, "utf-8");
//            code = "" + json.get("code");
//            
