...
//
///**
// * @fileName    : MemberJoinAgreementOk.java
// * @author      : 홍준성
// * @description : 회원가입 2단계 약관동의 액션을 위한 컨트롤러
// * @lastDate    : 2019. 3. 28.
// */
//@WebServlet("/member/member_join_agreement_ok.do")
//public class MemberJoinAgreementOk extends BaseController {
//    private static final long serialVersionUID = -4038450197836615081L;
//    
//    /**
...
//            return null;
//        } else {
//            if(regex.isIndexCheck(referer, "member_join_agreement.do")) {
//                // 거쳐야할 절차를 건너뛴 경우
//                logger.debug("정상적인 접근 방법이 아닌 사용자의 IP = " + web.getClientIP());
//                web.redirect(web.getRootPath() + "/error/error_page.do", null);
//                return null;
...
//        
//        web.redirect(web.getRootPath() + "/member/member_join_form.do", null);
//        
//        return null;
//    }
//
