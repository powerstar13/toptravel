...
//
///**
// * @fileName    : MemberPolicyInsertOk.java
// * @author      : 홍준성
// * @description : 정책안내 추가를 위한 액션 컨트롤러
// * @lastUpdate  : 2019. 4. 3.
// */
//@WebServlet("/member/member_policy_insert_ok.do")
//public class MemberPolicyInsertOk extends BaseController {
//    private static final long serialVersionUID = -107724393398254855L;
//    
//    /**
...
//            return null;
//        } else {
//            if(regex.isIndexCheck(referer, "member_policy_insert.do")) {
//                // 거쳐야할 절차를 건너뛴 경우
//                sqlSession.close();
//                logger.debug("정상적인 접근 방법이 아닌 사용자의 IP = " + web.getClientIP());
//                web.redirect(web.getRootPath() + "/error/error_page.do", null);
